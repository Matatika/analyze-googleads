...
datasets:
	source venv/bin/activate && convert bundle/analyze/datasets/tap-googleads/ rawdata/ bundle/analyze/datasets/tap-googleads/output || convert bundle/analyze/datasets/tap-googleads/ rawdata/ bundle/analyze/datasets/tap-googleads/output
