...
datasets:
	...
	mv matatika-dataset-to-html/matatika_dataset_to_html.py bundle/analyze/datasets/tap-google-ads/
	source venv/bin/activate && python bundle/analyze/datasets/tap-google-ads/matatika_dataset_to_html.py --datasets bundle/analyze/datasets/tap-google-ads/ --rawdata rawdata/ || python bundle/analyze/datasets/tap-google-ads/matatika_dataset_to_html.py --datasets bundle/analyze/datasets/tap-google-ads/ --rawdata rawdata/
	rm -rf matatika-dataset-to-html
	rm bundle/analyze/datasets/tap-google-ads/matatika_dataset_to_html.py
clean:
	rm -rf matatika-dataset-to-html
	rm bundle/analyze/datasets/tap-google-ads/matatika_dataset_to_html.py
